...
#define DEFAULT_LOCAL_CONNECTION_DESC_PATH "/tmp/read_respond_local_connection_desc_path.txt"
/* Default path to save the remote connection descriptor that should be passed from the other side */
#define DEFAULT_REMOTE_CONNECTION_DESC_PATH "/tmp/read_request_local_connection_desc_path.txt"
